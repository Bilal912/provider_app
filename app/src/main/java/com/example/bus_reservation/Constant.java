...
public class Constant {
    ...
    //https://providors.finalyearprojects.website
    public static final String Base_url="https://providors.finalyearprojects.website/Freelancer/Api.php";

    public static final String Base_url_stripe = "https://providors.finalyearprojects.website/Freelancer/provider_stripe.php?";

//    public static final String Base_url="http://marketist.eparking.website/Freelancer/Api.php";

    public static final String chat_image_url = "https://providors.finalyearprojects.website/uploads/chat/";

    public static final String Base_url_get_dashboard = "https://providors.finalyearprojects.website/Client/Api.php?providor_dashboard=1&providor_id=";
    ...
    public static final String booking_image_url="https://providors.finalyearprojects.website/uploads/booking/";

    public static final String Default_membership="https://providors.finalyearprojects.website/Freelancer/Api.php?payments_settings=true";
    ...
    public static final String Image_url="https://providors.finalyearprojects.website/Client/";

    public static final String gallery_url="https://providors.finalyearprojects.website/Freelancer/";
